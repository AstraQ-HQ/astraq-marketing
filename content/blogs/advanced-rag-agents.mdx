...
In our [previous guide on RAG systems](/blog/rag-complete-guide), we covered the fundamentals of building production-ready retrieval-augmented generation pipelines with Qdrant and FastEmbed. Now, let's take it to the next level with **agentic RAG**, where the LLM becomes an intelligent agent capable of multi-hop reasoning, query restructuring, and strategic retrieval.
...
<GithubLink
  repoName="astraq-hq/rag-agent-prompts"
  filePath="prompts/agent_prompt.py"
/>
...
**Related Articles:**
- [Building Production-Ready RAG Systems: A Complete Guide](/blog/rag-complete-guide) - Start here for the fundamentals
- [Evaluating RAG Systems with RAGAS: Metrics That Matter](/blog/evaluating-rag-ragas) - Measure what matters with the RAGAS framework
