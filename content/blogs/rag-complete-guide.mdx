...
<Callout variant="success" title="Advanced Guide" icon="arrow-right">
  **[Building Multi-Hop RAG Agents with Chain-of-Thought Reasoning](/blog/advanced-rag-agents)** - Learn how to build agentic RAG systems that can perform multi-hop reasoning, query restructuring, and use retrieval as a tool with LangChain.
</Callout>

---

*For advanced techniques like multi-hop reasoning, query restructuring, and agentic RAG, see our [Advanced RAG Agents Guide](/blog/advanced-rag-agents).*
